export const manualRevision = "2026-06-17.11";
...
export const manualSections: ManualSection[] = [
  {
    ...
    category: "software",
    title: "快速开始",
    summary: "登录、打开工作台、托盘面板和常用快捷键。",
    bodyMarkdown: `# 快速开始

Workshop Desktop 是一个轻量个人执行客户端，主要用于查看个人任务、写本地记录、打开任务工作面。

- 启动后会进入工作台；未连接远端时，本地项目和本地记录仍可使用。
- 点击 Dock、应用菜单或 \`Command+Option+W\` 打开工作台。
- 点击菜单栏或托盘图标打开托盘面板。
- 使用 \`Command+Option+N\` 新建个人记录。
- 工作台项目列表通过“添加项目”选择本地目录并新建本地项目，也可以连接远端后手动拉取 Workshop 项目；托盘面板免登录显示同一组项目入口。
...
- 工作台和托盘面板点击项目行都打开项目记录；任务便签从便签入口打开。
...
项目工作区围绕一个本地项目展开，通常包括本地记录、本地目录和可选任务源。

- 添加项目会先选择本地目录，项目名默认使用文件夹名。
- 本地项目可在工作台或托盘面板项目行右键菜单里重命名。
...
设置窗口集中处理刷新节奏、Dock 展示、快捷键、AI 协作和应用更新。
