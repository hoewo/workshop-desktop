...
现有代码和 README 已经支持托盘/菜单栏待办、NebulaAuth 登录、Workshop API 聚合、当前用户任务过滤、任务状态操作、每日刷新和便签窗口。当前缺口不是再扩功能，而是把真实登录、API 契约、交互路径、凭据风险和打包发布门槛一起验收，形成可内测交付的闭环。
